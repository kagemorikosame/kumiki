...
プレビューと同じ :class:`~novaedit.engine.render.FrameRenderer` と
:class:`~novaedit.engine.audio.AudioMixer` を使う。別経路にすると
...
from novaedit.core.model import Project
from novaedit.engine.audio import AudioMixer
from novaedit.engine.gpu import OffscreenGLContext
from novaedit.engine.render import FULL_QUALITY, FrameRenderer
