...
from novaedit.effects import EffectDefinition, registry
from novaedit.effects.spec import ColorSpec, SelectSpec
...
class EffectProcessor:
    ...
    :class:`~novaedit.engine.gpu.Compositor` と共有する。
    """
