...
from novaedit.core.model.ids import MediaId
from novaedit.core.model.media import MediaItem
from novaedit.core.model.timeline import Timeline
...
class Project:
    ...
    直接書き換えず、:mod:`novaedit.core.commands` を通して新しい :class:`Project` を
    受け取る。
