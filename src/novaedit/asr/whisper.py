...
配布方針の前提になる（:mod:`novaedit.asr.environment` を参照）。
"""
...
from novaedit.asr.environment import runtime_status
from novaedit.core.model import Transcript, TranscriptSegment, Word
...
def _ordered(segments: list[TranscriptSegment]) -> list[TranscriptSegment]:
    ...
    :class:`~novaedit.core.model.Transcript` は順序を不変条件にしている。認識器が
