...
from novaedit.core.model import MediaItem, Timeline, Track, TrackKind
from novaedit.core.timebase import FrameRate
from novaedit.ui.theme import Metrics
from novaedit.ui.timeline.layout import (
...
class TestVisibleClips:
    def test_only_visible_clips_are_returned(self, video_media: MediaItem) -> None:
        from novaedit.ui.timeline.painter import visible_clips
