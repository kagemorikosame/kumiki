...
:mod:`novaedit.ai.operations` に並べた操作を、ここで 1 つずつ MCP ツールへ包む。
...
from novaedit.ai.operations import OPERATIONS, ImageResult, Operation

__all__ = ["SERVER_NAME", "build_server", "build_tools", "tool_name", "tool_names"]

#: MCP サーバの名前。Claude 側でのツール名は ``mcp__novaedit__<ツール名>`` になる。
SERVER_NAME = "novaedit"
