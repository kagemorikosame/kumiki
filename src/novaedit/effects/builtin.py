...
使える uniform は :class:`~novaedit.effects.definition.EffectDefinition` の
説明を参照。
"""
...
from novaedit.effects.spec import CheckSpec, ColorSpec, SelectSpec, TrackSpec, ValueSpec
