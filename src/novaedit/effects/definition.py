...
エンジン層（:mod:`novaedit.engine.gpu.effects`）が行う。この分離のおかげで、
...
from novaedit.core.model import Effect, ParamValue
from novaedit.effects.spec import ParameterGroup, ParameterSpec, ParamInput
...
class EffectDefinition:
    ...
    ``fragment_shader`` は :data:`novaedit.engine.gpu.VERTEX_SHADER` と組み合わせる
...
#: アプリ全体で使う一覧。:mod:`novaedit.effects.builtin` が読み込み時に登録する。
