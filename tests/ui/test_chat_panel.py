...
from novaedit.ai.bridge import Approval
from novaedit.ai.session import AgentEvent, EventKind
from novaedit.core.commands import SplitClip
...
class TestFormatting:
    def test_bold_and_code_are_rendered(self) -> None:
        from novaedit.ui.chat.panel import _to_html
