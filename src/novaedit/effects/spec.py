...
from novaedit.core.model import AnimatedValue, ParamValue

#: まだ整えていない入力。モデルに入る前の値はここまで緩い。
#:
#: :data:`~novaedit.core.model.ParamValue` は「モデルに入った後」の型で、数値は
#: :class:`~novaedit.core.model.AnimatedValue` になっている。呼び出し側に毎回
