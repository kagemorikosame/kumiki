...
導入の仕組みそのものは :mod:`novaedit.runtime` にある。ここは「字幕起こしに何が
...
from novaedit.runtime import FeaturePack, PackStatus, activate_runtime, install_runtime
from novaedit.runtime import install_command as _install_command
