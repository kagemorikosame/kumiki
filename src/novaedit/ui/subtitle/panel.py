...
（:mod:`novaedit.core.projection`）が引き受ける。
...
from novaedit.core.io import SUBTITLE_FILTER, save_subtitles
from novaedit.core.jetcut import plan_cuts
from novaedit.core.model import MediaId, MediaItem, Project, SegmentId, TranscriptSegment
from novaedit.core.projection import project_clip
from novaedit.core.timebase import format_timecode
from novaedit.effects.sources import TEXT
...
from novaedit.ui.subtitle.dialogs import CleanupDialog, JetCutDialog
from novaedit.ui.subtitle.transcribe_dialog import TranscribeDialog
